...
class ChatwootHub
  BASE_URL = ENV.fetch('CHATWOOT_HUB_URL', 'https://chatwoot.com')
  ...
  def self.pricing_plan_quantity
    ...
    InstallationConfig.find_by(name: 'INSTALLATION_PRICING_PLAN_QUANTITY')&.value || 0 # Usuarios por empresa criada
  end
